<?php $__env->startSection('title', 'Sistem Penunjang Keputusan - Prioritas Stok'); ?>
...
<div class="dashboard-container mb-4">
    <div class="d-flex justify-content-between align-items-start">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('admin.ahp.print', $categoryId ? ['category_id' => $categoryId] : [])); ?>" target="_blank" class="btn btn-primary">
...
<div class="dashboard-container">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('admin.ahp.index')); ?>" class="d-flex gap-2 align-items-end">
                ...
                <?php if($categoryId): ?>
                    <a href="<?php echo e(route('admin.ahp.index')); ?>" class="btn btn-outline-danger">
    ...
    <div class="stat-grid mb-4">
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-primary mb-0"><?php echo e($statistics['total_products']); ?></h3>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-danger mb-0"><?php echo e($statistics['critical_stock']); ?></h3>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-warning mb-0"><?php echo e($statistics['high_priority']); ?></h3>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <h3 class="fw-bold text-success mb-0"><?php echo e(number_format($statistics['avg_score'] * 100, 1)); ?>%</h3>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <span class="badge bg-primary"><?php echo e(number_format($weights['sales_frequency'] * 100, 1)); ?>%</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <span class="badge bg-purple"><?php echo e(number_format($weights['min_stock_ratio'] * 100, 1)); ?>%</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <span class="badge bg-success"><?php echo e(number_format($weights['price'] * 100, 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-primary"><?php echo e(count($priorities)); ?> Produk</span>
            </div>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover" id="prioritiesTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="text-center">
                                ...
                                <?php else: ?>
                                    <span class="fw-bold text-muted"><?php echo e($index + 1); ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="ms-0">
                                        ...
                                        <small class="text-muted">ID: #PROD-<?php echo e($item['id']); ?></small>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-light-info text-dark"><?php echo e($item['category_name']); ?></span>
                            </td>
                            <td class="text-center">
                                <div class="d-flex flex-column align-items-center">
                                    <span class="fw-bold <?php echo e($item['stock'] <= $item['min_stock'] ? 'text-danger' : 'text-dark'); ?>">
                                        <?php echo e($item['stock']); ?> <?php echo e($item['unit']); ?>

                                    </span>
                                    <small class="text-muted">Min: <?php echo e($item['min_stock']); ?> <?php echo e($item['unit']); ?></small>
                                </div>
                            </td>
                            <td class="text-center">
                                <span class="badge bg-light-primary text-primary px-3"><?php echo e($item['sales_frequency']); ?>x</span>
                            </td>
                            <td>
                                <span class="fw-semibold text-dark">Rp <?php echo e(number_format($item['price'], 0, ',', '.')); ?></span>
                            </td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="progress progress-primary progress-sm w-100 me-3" style="height: 8px;">
                                        <div class="progress-bar shadow-none" role="progressbar" style="width: <?php echo e($item['score'] * 100); ?>%" aria-valuenow="<?php echo e($item['score']); ?>" aria-valuemin="0" aria-valuemax="1"></div>
                                    </div>
                                    <span class="fw-bold text-primary"><?php echo e(number_format($item['score'] * 100, 1)); ?>%</span>
                                </div>
                            </td>
                            <td class="text-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const topPrioritiesData = <?php echo json_encode($topPriorities, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Toko_Aira-FINAL deploy\resources\views/ahp/index.blade.php ENDPATH**/ ?>